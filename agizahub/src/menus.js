const MENUS = {
  ...
  ADMIN_MENU: () =>
    [
      ...
      "4️⃣  Refund order — force refund <ORDER-ID>",
      "5️⃣  Close order — close order <ORDER-ID>",
      "6️⃣  Override order field — override <ORDER-ID> <field> <VALUE>",
      "7️⃣  Revenue dashboard (today)",
      "8️⃣  Broadcast buyers — broadcast buyers <message>",
      "9️⃣  Broadcast all — broadcast all <message>",
      "🔟  Logout admin session",
      "",
      "Also supported: release/hold/approve/reject/payout approve/set tier/unban.",
      "Reply with a number, or type command directly. Type 0 for this menu.",
    ].join("\n"),
};
